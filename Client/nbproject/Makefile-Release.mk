...
# Object Files
OBJECTFILES= \
	${OBJECTDIR}/_ext/cf091272/functions.o \
	${OBJECTDIR}/main.o
...
${OBJECTDIR}/_ext/cf091272/functions.o: ../server/functions.c
	${MKDIR} -p ${OBJECTDIR}/_ext/cf091272
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/cf091272/functions.o ../server/functions.c
